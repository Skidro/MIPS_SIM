/********************************************************************************
 * File Name    :       sim.h
 * Description  :       This file contains the definitions necessary for decoding
 *                      MIPS32-ISA. It is same as decode.h but it is used by the
 *                      simulator whereas the decode.h is used by hardware code
