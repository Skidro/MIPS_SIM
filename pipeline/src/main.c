/********************************************************************************
 * File Name    :       main.c
 * Description  :       This file contains the code for reading the program file
 *                      and calling the main routines for executing the program
 *                      file in simulator and in map processor. It also parses
 *                      the program output from simulator and map processor and
 *                      dumps the results in relevant output files
...
int main (int argc, char *argv[]) 
{
    ...
    subr (text_memory, core_dump, data_memory, (instruction_count - 1), &pc_value, &tm, mapnum);
