/********************************************************************************
 * File Name    :       pipeline_stages.h
 * Description  :       This file contains the macro definitions required for 
 *                      modeling different execution stages of a MIPS processor
 * Author       :       Waqar Ali       (wali@ku.edu)
 * *****************************************************************************/

#ifndef PIPE_STAGES_H
#define PIPE_STAGES_H
...
#define generate_control_signals(opcode, funct, mem_read, mem_write, reg_write, reg_dst, beq, bne)		\
	do {													\
		switch (opcode)											\
		{												\
			case OP_RTYPE:										\
